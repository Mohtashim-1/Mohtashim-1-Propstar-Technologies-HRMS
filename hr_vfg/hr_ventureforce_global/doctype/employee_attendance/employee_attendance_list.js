    ...
    onload: function(listview) {
        ...
        listview.page.add_menu_item(__('Get Logs'), function() {
            var dialog = new frappe.ui.Dialog({
                ...
                primary_action_label: __("Fetch Logs")
            });
            dialog.show();
        });

        // Add "Mark Attendance" menu item with date selection
        listview.page.add_menu_item(__('Mark Attendance'), function() {
            var dialog = new frappe.ui.Dialog({
                ...
                primary_action: function () {
                    ...
                    console.log(args);
                    listview.call_for_selected_items(
                        "hr_vfg.hr_ventureforce_global.doctype.employee_attendance.attendance_connector.test_enqueue", 
                        args
                    );
                    dialog.hide();
                },
